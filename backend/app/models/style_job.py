...
class StyleJob(Base):
    ...
    style_preset_id: Mapped[UUID] = mapped_column(ForeignKey("style_presets.id"), nullable=False, index=True)
    ...
    style_preset: Mapped["StylePreset"] = relationship("StylePreset")
